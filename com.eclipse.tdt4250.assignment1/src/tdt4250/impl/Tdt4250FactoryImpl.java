...
public class Tdt4250FactoryImpl extends EFactoryImpl implements Tdt4250Factory {
	...
	public static Tdt4250Factory init() {
		try {
			Tdt4250Factory theTdt4250Factory = (Tdt4250Factory)EPackage.Registry.INSTANCE.getEFactory(Tdt4250Package.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case Tdt4250Package.STUDY_PROGRAM: return createStudyProgram();
			case Tdt4250Package.COURSE: return createCourse();
			case Tdt4250Package.STUDENT: return createStudent();
			case Tdt4250Package.COURSE_GROUP: return createCourseGroup();
			case Tdt4250Package.SPECIALISATION: return createSpecialisation();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case Tdt4250Package.STUDY_PROGRAM_NAME:
				return createStudyProgramNameFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case Tdt4250Package.STUDY_PROGRAM_NAME:
				return convertStudyProgramNameToString(eDataType, instanceValue);
			case Tdt4250Package.SEMESTER:
	 ...
	 * @generated
	 */
	public StudyProgramName createStudyProgramNameFromString(EDataType eDataType, String initialValue) {
		StudyProgramName result = StudyProgramName.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertStudyProgramNameToString(EDataType eDataType, Object instanceValue) {
